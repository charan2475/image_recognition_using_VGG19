...
Original file is located at
    https://colab.research.google.com/drive/1eC3BS5UDwWXw7Xe6RWGrJfmucNaxD6vN
"""
...
import pathlib
import glob
directory=pathlib.Path("/content/drive/MyDrive/train_dl")
...
predict("jisoo.jpg",model2,classes)

predict("jennie.jpg",model2,classes)

predict("lisa.jpg",model2,classes)

predict("rose.jpg",model2,classes)